...
import {CKEditorError, Collection} from "es-ckeditor/lib/utils";
/**
 * @license Copyright (c) 2003-2023, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */
...
import {CKEditorError as CKEditorError2, Collection as Collection2, DomEmitterMixin, ObservableMixin, isIterable} from "es-ckeditor/lib/utils";
...
import {CKEditorError as CKEditorError3, EmitterMixin, isNode, toArray} from "es-ckeditor/lib/utils";
...
import {createElement} from "es-ckeditor/lib/utils";
/**
 * @license Copyright (c) 2003-2023, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */
...
import {env, getEnvKeystrokeText, uid, delay} from "es-ckeditor/lib/utils";
...
import {FocusTracker, KeystrokeHandler} from "es-ckeditor/lib/utils";
...
import {global as global4, env as env2} from "es-ckeditor/lib/utils";
import {debounce} from "lodash-es";

// node_modules/@ckeditor/ckeditor5-ui/src/label/labelview.js
import {uid as uid2} from "es-ckeditor/lib/utils";
...
import {uid as uid3} from "es-ckeditor/lib/utils";
...
import {FocusTracker as FocusTracker2} from "es-ckeditor/lib/utils";
/**
 * @license Copyright (c) 2003-2023, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */
...
import {Rect, toUnit, getBorderWidths, global, CKEditorError as CKEditorError4} from "es-ckeditor/lib/utils";
import "@ckeditor/ckeditor5-ui/theme/components/input/input.css";
...
import {KeystrokeHandler as KeystrokeHandler2, FocusTracker as FocusTracker3, getOptimalPosition} from "es-ckeditor/lib/utils";
...
import {isVisible, EmitterMixin as EmitterMixin2} from "es-ckeditor/lib/utils";
/**
 * @license Copyright (c) 2003-2023, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */
...
import {FocusTracker as FocusTracker4, KeystrokeHandler as KeystrokeHandler3, Rect as Rect2, ResizeObserver, global as global2, isVisible as isVisible2, logWarning as logWarning2} from "es-ckeditor/lib/utils";
import {icons} from "es-ckeditor/lib/core";
...
import {uid as uid4} from "es-ckeditor/lib/utils";
/**
 * @license Copyright (c) 2003-2023, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */
...
import {FocusTracker as FocusTracker5, KeystrokeHandler as KeystrokeHandler4} from "es-ckeditor/lib/utils";
...
import {KeystrokeHandler as KeystrokeHandler5, FocusTracker as FocusTracker6} from "es-ckeditor/lib/utils";
...
import {global as global3, priorities, logWarning as logWarning3} from "es-ckeditor/lib/utils";
...
import {FocusTracker as FocusTracker7, KeystrokeHandler as KeystrokeHandler6} from "es-ckeditor/lib/utils";

// node_modules/@ckeditor/ckeditor5-ui/src/colorselector/documentcolorcollection.js
import {Collection as Collection3, ObservableMixin as ObservableMixin2} from "es-ckeditor/lib/utils";
/**
 * @license Copyright (c) 2003-2023, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */
...
import {CKEditorError as CKEditorError5} from "es-ckeditor/lib/utils";
/**
 * @license Copyright (c) 2003-2023, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */
...
import {getOptimalPosition as getOptimalPosition2, global as global5, isRange, toUnit as toUnit2} from "es-ckeditor/lib/utils";
...
import {DomEmitterMixin as DomEmitterMixin2, ResizeObserver as ResizeObserver2, first, global as global6, isVisible as isVisible3} from "es-ckeditor/lib/utils";
...
import {DomEmitterMixin as DomEmitterMixin3, Rect as Rect3, verifyLicense} from "es-ckeditor/lib/utils";
...
import {ObservableMixin as ObservableMixin3, isVisible as isVisible4, FocusTracker as FocusTracker8} from "es-ckeditor/lib/utils";
/**
 * @license Copyright (c) 2003-2023, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */
...
import {ContextPlugin} from "es-ckeditor/lib/core";
/**
 * @license Copyright (c) 2003-2023, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */
...
import {ObservableMixin as ObservableMixin4} from "es-ckeditor/lib/utils";
...
import {Plugin} from "es-ckeditor/lib/core";
import {CKEditorError as CKEditorError6, FocusTracker as FocusTracker9, Rect as Rect4, toUnit as toUnit3} from "es-ckeditor/lib/utils";
...
import {global as global7, toUnit as toUnit4, Rect as Rect5} from "es-ckeditor/lib/utils";
...
import {getOptimalPosition as getOptimalPosition3, global as global8, toUnit as toUnit5, Rect as Rect6} from "es-ckeditor/lib/utils";

// node_modules/@ckeditor/ckeditor5-ui/src/search/text/searchtextview.js
import {FocusTracker as FocusTracker11, KeystrokeHandler as KeystrokeHandler7} from "es-ckeditor/lib/utils";

// node_modules/@ckeditor/ckeditor5-ui/src/search/text/searchtextqueryview.js
import {icons as icons2} from "es-ckeditor/lib/core";
/**
 * @license Copyright (c) 2003-2023, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */
...
import {FocusTracker as FocusTracker10} from "es-ckeditor/lib/utils";
/**
 * @license Copyright (c) 2003-2023, CKSource Holding sp. z o.o. All rights reserved.
 * For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
 */
...
import {Plugin as Plugin2} from "es-ckeditor/lib/core";
import {FocusTracker as FocusTracker12, Rect as Rect7, ResizeObserver as ResizeObserver3, env as env3, global as global9, toUnit as toUnit6} from "es-ckeditor/lib/utils";
...
import {Plugin as Plugin3} from "es-ckeditor/lib/core";
import {Rect as Rect8, ResizeObserver as ResizeObserver4, toUnit as toUnit8} from "es-ckeditor/lib/utils";

// node_modules/@ckeditor/ckeditor5-ui/src/toolbar/block/blockbuttonview.js
import {toUnit as toUnit7} from "es-ckeditor/lib/utils";
